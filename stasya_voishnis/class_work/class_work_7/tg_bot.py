...
ABOUT_TEXT = """ *Обо мне* Привет! Меня зовут *Анастасия Войшнис*,  
Мне 25 лет. Я учусь на тестировщика.  
"""
...
async def contact(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    keyboard = InlineKeyboardMarkup([
        [InlineKeyboardButton("Написать Анастасии", url="https://t.me/stasya_mylife"),
         InlineKeyboardButton("Написать Максиму", url="https://t.me/mimishka69")]
    ])
    await update.message.reply_text(
