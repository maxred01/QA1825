...
TEST_CASES = [
    ...
    TestCase(
        name="Страница Регистрация",
        url="https://go.rocketdata.io/auth/register",
        method="GET"
    ),
    TestCase(
        name="Страница Площадки",
    ...
    TestCase(
        name="Страница Карьера",
        url="https://rocketdata.ru/vacancies",
        method="GET"
    ),
    TestCase(
        name="Страница Кейсы",
        url="https://rocketdata.ru/usecases",
        method="GET"
    ),
    TestCase(
        name="Страница Тарифы",
        url="https://rocketdata.ru/rates",
        method="GET"
    ),
    TestCase(
        name="Страница Партнерам",
        url="https://rocketdata.ru/agencies",
        method="GET"
    ),
    TestCase(
        name="Страница Блог",
        url="https://rocketdata.ru/blog",
        method="GET"
    ),
    TestCase(
        name="Страница Эксперты",
        url="https://rocketdata.ru/experts",
        method="GET"
    ),
    TestCase(
