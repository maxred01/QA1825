...
# # ############################################################
#
# # Инкапсуляция те объекты к которым мы не можем обратиться
#
# class BankAccount:
...
#
# name_account = BankAccount("Ирина")
...
# Создайте класс Vehicle с атрибутами brand и year, и методом info()
# (печатает бренд и год). Создайте подкласс ElectricCar, который добавляет атрибут battery_capacity.
# Пример:
