...
class ShopPage(WebPage):
    ...
    btn_header_1 = WebElement(xpath='//img[@alt="STARSHIP TORCH"]')

    text_header_1 = WebElement(xpath='//span[@class="ProductItem__Title Heading"]//a[@href="/collections/trending/products/starship-torch-2"]')
